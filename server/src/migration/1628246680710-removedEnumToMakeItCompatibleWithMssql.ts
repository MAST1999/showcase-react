...
export class removedEnumToMakeItCompatibleWithMssql1628246680710 implements MigrationInterface {
    name = 'removedEnumToMakeItCompatibleWithMssql1628246680710'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "files" ADD CONSTRAINT "FK_7f49652dfc49378acb82a39b479" FOREIGN KEY ("infoUuid") REFERENCES "infos"("uuid") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
